    ...
    <div className="contact-container">
      ...
      <div className="contact-details">
        ...
        <div className="contact-item">
          ...
          <a href="www.linkedin.com/in/nethmi-vaas-1644072b2" className="contact-text" target="_blank" rel="noopener noreferrer">
            LinkedIn 
          </a>
        </div>
        <div className="contact-item">
          <FaGithub className="contact-icon" />
          <a href="https://github.com/Nethmi-Vaas" className="contact-text" target="_blank" rel="noopener noreferrer">
            GitHub 
          </a>
        </div>
      </div>
